        ...
        <Card className="border-gray-100 shadow-sm overflow-hidden">
            <CardHeader className="bg-gray-50/30 border-b border-gray-100 py-6 px-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-lg font-black text-gray-900 font-outfit">Lični podaci</CardTitle>
                        <CardDescription className="text-xs font-bold text-gray-400">Vaše ime koje će biti vidljivo u sistemu.</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6 max-w-md">
                    <div className="space-y-2">
                        <Label className="text-[10px] font-bold text-gray-400 ml-1">Puno ime i prezime</Label>
                        <Input
