    ...
    return (
        ...
        >
            <div className="space-y-6 text-left">
                <div className="p-5 bg-gray-50/50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-4">
                    <div className="h-12 w-12 rounded-xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 flex items-center justify-center font-semibold text-primary shadow-sm">
                        {user?.full_name?.[0]}
                    </div>
                ...
                <div className="space-y-2">
                    <Label className="text-[10px] font-bold text-gray-400 dark:text-gray-500 ml-1">Sistemska uloga</Label>
                    <Select value={roleId} onValueChange={setRoleId}>
                        ...
                        <SelectContent className="rounded-xl border-gray-100 dark:border-gray-800 p-1">
